...
BLOG_AUTHOR = "The Mathematical Epidemiology research group"  # (translatable)
BLOG_TITLE = "Mathematical Epidemiology"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://Epidemiologia.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
BASE_URL = "https://Epidemiologia.github.io/"
BLOG_EMAIL = "fccoelho@fgv.br"
BLOG_DESCRIPTION = "EMAp's Mathematical epidemiology research website."  # (translatable)
...
NAVIGATION_LINKS = {
    ...
    DEFAULT_LANG: (
        ...
        ('http://emap.fgv.br', 'About us', 'icon-user'),
...
LOGO_URL = 'galleries/logo_pq.png'
